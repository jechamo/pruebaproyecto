...
import org.example.infra.model.Filter;
...
import static org.example.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                org.example.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? org.example.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? org.example.infra.model.SortOrder.DESCENDING
                            : org.example.infra.model.SortOrder.UNSORTED;
                }
